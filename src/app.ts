...
import GobiernaRoutes from './routes/gobierna.routes'
import HabitaRoutes from "./routes/habita.routes";
...
export class App {
    ...
    routes() {
        ...
        this.app.use('/gobierna', GobiernaRoutes)
        this.app.use('/habita', HabitaRoutes)
